<template>
  <!-- <UICard class="h-[70px] p-4 flex duration-500" :class="finalHeigthMain">
    <div class="mr-2">
    ...
    <div class="w-[85%]">
      <textarea 
        ...
        class="w-full rounded-sm resize-none p-2 text-sm outline-none"
        :class="finalHeigthTextarea"
      >{{ textoPost }}</textarea>
      <div v-if="typing || textoPost !== ''" class="flex justify-end mt-4">
