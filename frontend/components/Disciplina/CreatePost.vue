<template>
  <UICard class="p-4 flex justify-evenly duration-500" :class="finalHeigthMain">
    <div class="mr-2">
      <img src="data:image/jpeg;base64," 
        alt="Foto Perfil"
        class="h-10 w-10 lg:h-10 lg:w-10 rounded-[50%]" 
      >
    </div>
    <div class="w-[90%]">
      <textarea 
        @focusin="typing = true" @focusout="typing = false" 
        placeholder="Postar algo na disciplina..."
        class="w-full rounded-sm resize-none p-2 text-sm
        outline-none hover:border hover:border-x-zinc-200"
        :class="finalHeigthTextarea"
        v-model="textoPost"
      >{{ textoPost }}</textarea>
      <div v-if="showButtons" class="flex justify-end">
        <UIIcon icon="mdi:paperclip" txtSize="text-xl" class="text-zinc-600 hover:bg-zinc-200 mx-1" />
        <UIIcon icon="ion:send-sharp" txtSize="text-xl" class="text-zinc-600 hover:bg-zinc-200 mx-1" />
      </div> 
    </div>
  </UICard>
</template>
...
const finalHeigthMain = computed(() => {
  return typing.value === true || textoPost.value !== ''? 'h-72' : 'h-[74px]';
});

const finalHeigthTextarea = computed(() => {
  return typing.value === true || textoPost.value !== ''? 'h-[90%] border border-x-zinc-200' : 'h-[40px]';
});

const showButtons = computed(() => {
  return typing.value === true || textoPost.value !== '';
});
